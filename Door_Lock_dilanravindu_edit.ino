/*
 *solenoid version by dilan ravindu 
 *www.dilanravindu1777@gmail.com 
 *facebook dilanravindu MB
...
void setup() {
  ...
  pinMode(sol, OUTPUT);            // Configure Servo to Pin 4
  digitalWrite(sol,LOW);               // Make sure door is locked
